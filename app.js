...
const DB ='mongodb+srv://nimish:nimishdevpura@cluster0.sgpbj.mongodb.net/emp_data?retryWrites=true&w=majority';
...
app.post("/pssd",async(req,res)=>{
	try{
		...
		let MongoClient = require('mongodb').MongoClient;
         ...
         let url = "mongodb+srv://amancozura:conzura123@cluster0.udqsq.mongodb.net/emp_data?retryWrites=true&w=majority";
